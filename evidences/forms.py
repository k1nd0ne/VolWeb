...
class EvidenceForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'dump_name': TextInput(attrs={'class': 'form-control form-control-sm', 'type': 'text', 'required': ''}),
            'dump_os': Select(attrs={'value': 'Windows', 'class': 'form-select form-control form-control-sm'}),
