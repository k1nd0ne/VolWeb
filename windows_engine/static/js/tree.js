...
function TreeNode(userObject, process, options){
	...
	*/
	...
	this.getProcess = function(node){
		if(node instanceof TreeNode){
			if(node.getProcessObject() == process){
				return true;
			}
		}
	}
