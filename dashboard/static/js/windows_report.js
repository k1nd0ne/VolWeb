/*
The Reporting functions linked to Windows Analysis.
  - For each plugin, a hidden table is storing the tagged elements.
  - The reporting function is extracting each table and using autotable to generate a pdf
*/
