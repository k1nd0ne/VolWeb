class FileUpload {
    ...
    initFileUpload() {
        ...
        const investName = document.getElementById('invest-title');
        const investDesc = document.getElementById('invest-description');
        const filefield = document.getElementById('fileupload');
        if(title.value == ""){
                    alertBox.innerHTML = "<p class='text-danger'>Please fill out the Title field.</p>";
                    uploadForm.reset();
                    return;
        ...
        if(investigators.value == ''){
                    alertBox.innerHTML = "<p class='text-danger'>Please Select at least one Forensics Expert on the investigation.</p>";
                    uploadForm.reset();
                    return;
